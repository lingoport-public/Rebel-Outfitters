...
let Hamburger = {
    ...
    render: async () => {
       ...
       // let localeCTX = i18n.getString("Hamburger", "localeCTX");
        ...
        let view = `
            ...
            <div class="start">
                ...
                <select id="locale" class="hamDrop">
                    ...
                    <option value="ia">${localePL}</option>
                    <option value="sa">${localePT}</option>
                    <option value="eo">${localeES}</option> 
                    <option value="sa">${localeRU}</option>
